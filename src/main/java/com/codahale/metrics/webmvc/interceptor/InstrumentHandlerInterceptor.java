...
public class InstrumentHandlerInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		counter = metricsFactory.getCounter(MetricRegistry.name(this.getClass(), uri, "requests" ));
		counter.inc();
		return true;
	}
