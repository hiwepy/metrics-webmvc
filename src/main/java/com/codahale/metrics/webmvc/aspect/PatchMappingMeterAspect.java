...
public class PatchMappingMeterAspect extends AbstractMetricMethodAspect<PatchMapping, Meter> {
	...
	public PatchMappingMeterAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public PatchMappingMeterAspect(final MetricRegistry metricRegistry, boolean absolute) {
