...
public class RequestMappingTimerAspect extends AbstractMetricMethodAspect<RequestMapping, Timer> implements Ordered {
	...
	public RequestMappingTimerAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public RequestMappingTimerAspect(final MetricRegistry metricRegistry, boolean absolute) {
		super(metricRegistry, absolute, ANNOTATION, METHOD_FILTER);
	}

	@Override
	protected Object invoke(ProceedingJoinPoint joinPoint, Timer timer, RequestMapping annotation) throws Throwable {
	...
	@Override
	protected Timer buildMetric(MetricRegistry metricRegistry, String metricName, RequestMapping annotation) {
