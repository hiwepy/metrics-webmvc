...
public class PutMappingCounterAspect extends AbstractMetricMethodAspect<PutMapping, Counter> {
	...
	public PutMappingCounterAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public PutMappingCounterAspect(final MetricRegistry metricRegistry, boolean absolute) {
		super(metricRegistry, absolute, ANNOTATION, METHOD_FILTER);
	}

	@Override
	protected Object invoke(ProceedingJoinPoint joinPoint, Counter counter, PutMapping annotation) throws Throwable {
		counter.inc();
		return joinPoint.proceed();
	}

	@Override
	protected Counter buildMetric(MetricRegistry metricRegistry, String metricName, PutMapping annotation) {
