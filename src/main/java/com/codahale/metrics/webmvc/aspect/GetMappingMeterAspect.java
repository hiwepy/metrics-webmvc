...
public class GetMappingMeterAspect extends AbstractMetricMethodAspect<GetMapping, Meter> {
	...
	public GetMappingMeterAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public GetMappingMeterAspect(final MetricRegistry metricRegistry, boolean absolute) {
