...
public class PutMappingMeterAspect extends AbstractMetricMethodAspect<PutMapping, Meter> {
	...
	public PutMappingMeterAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public PutMappingMeterAspect(final MetricRegistry metricRegistry, boolean absolute) {
