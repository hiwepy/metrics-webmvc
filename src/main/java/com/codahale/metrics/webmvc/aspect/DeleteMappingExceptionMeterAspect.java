...
public class DeleteMappingExceptionMeterAspect extends AbstractMetricMethodAspect<DeleteMapping, Meter> implements Ordered {
	...
	public DeleteMappingExceptionMeterAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public DeleteMappingExceptionMeterAspect(final MetricRegistry metricRegistry, boolean absolute) {
