...
public class RequestMappingMeterAspect extends AbstractMetricMethodAspect<RequestMapping, Meter> implements Ordered {
	...
	public RequestMappingMeterAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public RequestMappingMeterAspect(final MetricRegistry metricRegistry, boolean absolute) {
