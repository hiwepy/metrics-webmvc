...
public class DeleteMappingTimerAspect extends AbstractMetricMethodAspect<DeleteMapping, Timer> {
	...
	public DeleteMappingTimerAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public DeleteMappingTimerAspect(final MetricRegistry metricRegistry, boolean absolute) {
		super(metricRegistry, absolute, ANNOTATION, METHOD_FILTER);
	}

	@Override
	protected Object invoke(ProceedingJoinPoint joinPoint, Timer timer, DeleteMapping annotation) throws Throwable {
	...
	@Override
	protected Timer buildMetric(MetricRegistry metricRegistry, String metricName, DeleteMapping annotation) {
