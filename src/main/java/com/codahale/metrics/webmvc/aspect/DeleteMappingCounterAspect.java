...
public class DeleteMappingCounterAspect extends AbstractMetricMethodAspect<DeleteMapping, Counter> {
	...
	public DeleteMappingCounterAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public DeleteMappingCounterAspect(final MetricRegistry metricRegistry, boolean absolute) {
		super(metricRegistry, absolute, ANNOTATION, METHOD_FILTER);
	}

	@Override
	protected Object invoke(ProceedingJoinPoint joinPoint, Counter counter, DeleteMapping annotation) throws Throwable {
		counter.inc();
		return joinPoint.proceed();
	}

	@Override
	protected Counter buildMetric(MetricRegistry metricRegistry, String metricName, DeleteMapping annotation) {
