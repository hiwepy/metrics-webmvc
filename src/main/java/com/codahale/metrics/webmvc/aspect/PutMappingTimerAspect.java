...
public class PutMappingTimerAspect extends AbstractMetricMethodAspect<PutMapping, Timer> {
	...
	public PutMappingTimerAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public PutMappingTimerAspect(final MetricRegistry metricRegistry, boolean absolute) {
		super(metricRegistry, absolute, ANNOTATION, METHOD_FILTER);
	}

	@Override
	protected Object invoke(ProceedingJoinPoint joinPoint, Timer timer, PutMapping annotation) throws Throwable {
	...
	@Override
	protected Timer buildMetric(MetricRegistry metricRegistry, String metricName, PutMapping annotation) {
