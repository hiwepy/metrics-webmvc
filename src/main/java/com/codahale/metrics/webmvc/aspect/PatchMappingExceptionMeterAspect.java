...
public class PatchMappingExceptionMeterAspect extends AbstractMetricMethodAspect<PatchMapping, Meter> implements Ordered {
	...
	public PatchMappingExceptionMeterAspect(final MetricRegistry metricRegistry) {
		this(metricRegistry, false);
	}
	
	public PatchMappingExceptionMeterAspect(final MetricRegistry metricRegistry, boolean absolute) {
		super(metricRegistry, absolute, ANNOTATION, METHOD_FILTER);
	}

	@Override
	protected Object invoke(ProceedingJoinPoint joinPoint, Meter meter, PatchMapping annotation) throws Throwable {
		try {
	...
	@Override
	protected Meter buildMetric(MetricRegistry metricRegistry, String metricName, PatchMapping annotation) {
